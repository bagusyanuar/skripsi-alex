...
<div style="position: relative">
    ...
    <div>
        <div class="text-center report-header-title">UNIVERSITAS AUB</div>
        <div class="text-center report-header-sub-title">
            <span>Jl. Walanda Maramis No.29, Nusukan, Kec. Banjarsari, Kota Surakarta, Jawa Tengah 57135</span>
        </div>
    </div>
</div>
