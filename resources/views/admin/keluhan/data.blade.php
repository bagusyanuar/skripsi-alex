    ...
    <div class="container-fluid pt-3">
        <div class="d-flex align-items-center justify-content-between mb-3">
            ...
            <ol class="breadcrumb breadcrumb-transparent mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Daftar Keluhan Mahasiswa
                </li>
            </ol>
        </div>
        <div class="w-100 p-2">
            ...
            <table id="table-data" class="display w-100 table table-bordered">
                ...
                <tr>
                    ...
                    <th width="15%" class="f12">Tanggal</th>
                    <th class="f12">Nama Mahasiswa</th>
                    <th width="15%" class="f12">Kelas</th>
                    <th width="15%" class="f12">Keluhan</th>
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            table = DataTableGenerator('#table-data', '/keluhan/riwayat', [
            ...
            $('#btn-cetak').on('click', function (e) {
                ...
                let tgl1 = $('#tgl1').val();
                let tgl2 = $('#tgl2').val();
                window.open('/keluhan/cetak?tgl1=' + tgl1 + '&tgl2=' + tgl2, '_blank');
            })
        });
    </script>
@endsection
